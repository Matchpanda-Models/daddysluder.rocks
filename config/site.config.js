...
export default {
  // Basic Site Info
  site: {
    name: "DaddysLuder",                    // Model display name
    domain: "daddysluder.rocks",            // Domain without https://
    url: "https://daddysluder.rocks",       // Full URL with https://
    language: "de",
    locale: "de_DE"
  },
  ...
  // Model Information
  model: {
    id: "4760438",                        // MyDirtyHobby ID (from profile URL)
    name: "DaddysLuder",                    // Display name
    username: "DaddysLuder",            // MDH username
    tagline: "Dein heißes Girl von nebenan",

    // Profile URL (with your affiliate tracking)
    profileUrl: "https://www.mydirtyhobby.de/profil/4760438-DaddysLuder",
  ...
  feed: {
    ...
    url: "https://www.mydirtyhobby.com/api/amateurvideos/?amateurId=4760438&ats=eyJhIjoyODQ4MTQsImMiOjQ5ODYzMzc3LCJuIjoyMSwicyI6MjQxLCJlIjo5NTQyLCJwIjoyfQ==&limit=200&offset=0&language=de&aboutme=1&softcore=hardcore",
    ...
    trackingParams: {
      ...
      ad_id: "API",
      atc: "cal-daddysluder-rocks"              // Unique identifier (domain with dashes)
    }
  },
